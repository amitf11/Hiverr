    ...
    return (
        <section className="gig-purchase">
            <section className="flex inner-container">
                ...
                <section className="flex column align-center justify-center payment-section">
                    <div className="flex header">
                        <h1>Payment Option</h1>
                    </div>

                    <div className="flex column align-center credit-debit-card-container">
                    ...
                    <form className="flex column align-center justify-center payment-form">

                        <div className="flex column align-center justigy-center card-details">
                            <div className="flex column align-center justify-center card-number">
