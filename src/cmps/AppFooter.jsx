export function AppFooter() {
    return (
        <footer className="app-footer-container">
            <div className="app-footer flex space-between align-center">
                <div className="left flex align-center">
                    ...
                    <h1 className='logo'>Hiverr<span>.</span></h1>

                    <p className="flex align-center"> <span>© Hiverr international Ltd. 2024</span></p>
                </div>

                <div className="right flex align-center space-between social-links">
                    <ul className="social-list clean-list flex">
                        <li className="tiktok">
                            <a href="https://www.tiktok.com/@fiverr" target="_blank" rel="noopener" className="social-link flex" aria-label="Fiverr on TikTok">
                        ...
                        <li className="instagram">
                            <a href="https://www.instagram.com/fiverr/" target="_blank" rel="noopener" className="social-link flex" aria-label="Fiverr on Instagram">
                                <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><g fill="#62646a"><path d="M15.1814 6.06504C15.8442 6.06504 16.3814 5.52778 16.3814 4.86504C16.3814 4.2023 15.8442 3.66504 15.1814 3.66504C14.5187 3.66504 13.9814 4.2023 13.9814 4.86504C13.9814 5.52778 14.5187 6.06504 15.1814 6.06504Z"></path><path d="M10 15C7.2425 15 5 12.7575 5 10C5 7.2425 7.2425 5 10 5C12.7575 5 15 7.2425 15 10C15 12.7575 12.7575 15 10 15ZM10 7.5C8.62125 7.5 7.5 8.62125 7.5 10C7.5 11.3787 8.62125 12.5 10 12.5C11.3787 12.5 12.5 11.3787 12.5 10C12.5 8.62125 11.3787 7.5 10 7.5Z"></path><path d="M15 20H5C2.43 20 0 17.57 0 15V5C0 2.43 2.43 0 5 0H15C17.57 0 20 2.43 20 5V15C20 17.57 17.57 20 15 20ZM5 2.5C3.83125 2.5 2.5 3.83125 2.5 5V15C2.5 16.1912 3.80875 17.5 5 17.5H15C16.1688 17.5 17.5 16.1688 17.5 15V5C17.5 3.83125 16.1688 2.5 15 2.5H5Z">
                                </path>
                                </g>
                                </svg>
                            </a>
                        ...
                        <li className="facebook">
                            <a href="https://www.facebook.com/Fiverr/" target="_blank" rel="noopener" className="social-link flex" aria-label="Fiverr on Facebook">
                        ...
                        <li className="pinterest">
                            <a href="https://www.pinterest.com/fiverr/" target="_blank" rel="noopener" className="social-link flex" aria-label="Fiverr on Pinterest">
                                <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><g fill="#62646a"><path d="M10 0C4.5 0 0 4.5 0 10C0 14.25 2.625 17.875 6.375 19.25C6.25 18.5 6.25 17.25 6.375 16.375C6.5 15.625 7.5 11.375 7.5 11.375C7.5 11.375 7.25 10.875 7.25 10C7.25 8.625 8.125 7.5 9.125 7.5C10 7.5 10.375 8.125 10.375 8.875C10.375 9.75 9.875 11 9.5 12.25C9.25 13.25 10 14 11 14C12.75 14 14.125 12.125 14.125 9.375C14.125 7 12.375 5.25 10 5.25C7.125 5.25 5.5 7.375 5.5 9.625C5.5 10.5 5.875 11.375 6.25 11.875C6.25 12.125 6.25 12.25 6.25 12.375C6.125 12.75 6 13.375 6 13.5C6 13.625 5.875 13.75 5.625 13.625C4.375 13 3.625 11.25 3.625 9.75C3.625 6.625 5.875 3.75 10.25 3.75C13.75 3.75 16.375 6.25 16.375 9.5C16.375 13 14.25 15.75 11.125 15.75C10.125 15.75 9.125 15.25 8.875 14.625C8.875 14.625 8.375 16.5 8.25 17C8 17.875 7.375 19 7 19.625C8 19.875 9 20 10 20C15.5 20 20 15.5 20 10C20 4.5 15.5 0 10 0Z">
                                </path>
                                </g>
                                </svg>
                            </a>
                        ...
                        <li className="twitter">
                            <a href="https://twitter.com/fiverr" target="_blank" rel="noopener" className="social-link flex" aria-label="Fiverr on Twitter">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="#74767E"><g clipPath="url(#twitter_icon_svg__a)"><path d="M11.64 8.464 18.923 0h-1.725l-6.323 7.35L5.824 0H0l7.636 11.114L0 19.99h1.726l6.676-7.761 5.334 7.76h5.824L11.64 8.465Zm-2.363 2.747-.773-1.106-6.157-8.806h2.65l4.969 7.107.774 1.106 6.458 9.238h-2.65l-5.27-7.538Z"></path></g><defs><clipPath id="twitter_icon_svg__a">
