    ...
    return (
        <div className="center main-categories">
            ...
            <ul className="clean-list flex">
                <li>
                    <a href="/gig?category=graphics-design">
                ...
                <li>
                    <a href="/gig?category=online-marketing">
                ...
                <li>
                    <a href="/gig?category=writing-translation">
                ...
                <li>
                    <a href="/gig?category=video-animation">
                ...
                <li>
                    <a href="/gig?category=music-audio">
                ...
                <li>
                    <a href="/gig?category=programming-tech">
                ...
                <li>
                    <a href="/gig?category=photography">
