            ...
            <div className='flex column packages-tabs'>
                ...
                <div className='package-main'>
                    <div className='flex column package-content'>
                        <h3 className='flex space-between align-center'>
                            <b> {plan.charAt(0).toUpperCase() + plan.slice(1)}</b>
                            <div className='price'>
                        ...
                        <div className='flex second-row'>
                            <div className='flex align-center delivery'>
                                ...
                                <span>{selectedPackage.daysToMake}-day delivery</span>
                            </div>
                        ...
                        <section className="included-section">
                            <ul className="clean-list">
                                <li className='flex align-center'><div><svg width='16' height='16' viewBox='0 0 11 9' xmlns='http://www.w3.org/2000/svg' fill={selectedPackage.whatIncluded.ConceptIncluded ? 'currentFill' : '#74767e'}><path d='M3.645 8.102.158 4.615a.536.536 0 0 1 0-.759l.759-.758c.21-.21.549-.21.758 0l2.35 2.349L9.054.416c.21-.21.55-.21.759 0l.758.758c.21.21.21.55 0 .759L4.403 8.102c-.209.21-.549.21-.758 0Z'></path></svg></div><span>1 Concept Included</span></li>
                                <li className='flex align-center' ><div><svg width='16' height='16' viewBox='0 0 11 9' xmlns='http://www.w3.org/2000/svg' fill={selectedPackage.whatIncluded.IncludeSourceFile ? 'currentFill' : '#74767e'}><path d='M3.645 8.102.158 4.615a.536.536 0 0 1 0-.759l.759-.758c.21-.21.549-.21.758 0l2.35 2.349L9.054.416c.21-.21.55-.21.759 0l.758.758c.21.21.21.55 0 .759L4.403 8.102c-.209.21-.549.21-.758 0Z'></path></svg></div><span>Include Source File</span></li>
                                <li className='flex align-center'><div><svg width='16' height='16' viewBox='0 0 11 9' xmlns='http://www.w3.org/2000/svg' fill={selectedPackage.whatIncluded.StationeryDesigns ? 'currentFill' : '#74767e'}><path d='M3.645 8.102.158 4.615a.536.536 0 0 1 0-.759l.759-.758c.21-.21.549-.21.758 0l2.35 2.349L9.054.416c.21-.21.55-.21.759 0l.758.758c.21.21.21.55 0 .759L4.403 8.102c-.209.21-.549.21-.758 0Z'></path></svg></div><span>Stationery Designs</span></li>
                            </ul>
                        </section>
                    ...
                    <div className='continue-container'>
                        <Link className='clean-link' to={{
                            pathname: `/gig/payment/${gig._id}`,
                            state: { selectedPackage: selectedPackage }
                        }}>
                            {/* //  to={`/gig/payment/${gig._id}`} */}
